...
print(feature[:, 0]) # alle werte der ersten Spalte

print(np.mean(feature[:, 0])) # mittelwert der ersten spalte

print(feature[(len(feature)-1), :]) # vorletzte Zeile

print(feature[14:24, :]) # 15 - 25 Zeile

print(feature[::3]) # jede dritte Zeile
